"""
Agente PerfectpayAPIMaster - Integração com ADK
...
class PerfectpayapimasterAgent(LlmAgent if ADK_AVAILABLE else object):
    """
    PerfectpayAPIMaster - Agente especializado migrado do multi-agent-ai-system.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.get_attr("agent_name") = "PerfectpayAPIMaster"
...
def create_agent(**kwargs) -> PerfectpayapimasterAgent:
    """Factory function para criar instância do agente."""
    return PerfectpayapimasterAgent(**kwargs)
