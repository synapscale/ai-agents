"""
Agente PaytAPIMaster - Integração com ADK
...
class PaytapimasterAgent(LlmAgent if ADK_AVAILABLE else object):
    """
    PaytAPIMaster - Agente especializado migrado do multi-agent-ai-system.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.get_attr("agent_name") = "PaytAPIMaster"
...
def create_agent(**kwargs) -> PaytapimasterAgent:
    """Factory function para criar instância do agente."""
    return PaytapimasterAgent(**kwargs)
