"""
Agente HotmartAPIMaster - Integração com ADK
...
class HotmartapimasterAgent(LlmAgent if ADK_AVAILABLE else object):
    """
    HotmartAPIMaster - Agente especializado migrado do multi-agent-ai-system.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.get_attr("agent_name") = "HotmartAPIMaster"
...
def create_agent(**kwargs) -> HotmartapimasterAgent:
    """Factory function para criar instância do agente."""
    return HotmartapimasterAgent(**kwargs)
