"""
Agente metaphor_architect - Integração com ADK
...
class MetaphorArchitectAgent(LlmAgent if ADK_AVAILABLE else object):
    """
    metaphor_architect - Agente especializado migrado do multi-agent-ai-system.
    
    Categoria: agents_copywriters
    Especialização: metaphor_creation
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.get_attr("specialization") = "metaphor_creation"
        self.get_attr("category") = "agents_copywriters"
        self.get_attr("agent_name") = "metaphor_architect"
...
def create_agent(**kwargs) -> MetaphorArchitectAgent:
    """Factory function para criar instância do agente."""
    return MetaphorArchitectAgent(**kwargs)
