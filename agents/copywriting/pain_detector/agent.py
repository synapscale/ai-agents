"""
Agente pain_detector - Integração com ADK
...
class PainDetectorAgent(LlmAgent if ADK_AVAILABLE else object):
    """
    pain_detector - Agente especializado migrado do multi-agent-ai-system.
    
    Categoria: agents_copywriters
    Especialização: pain_detection
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.get_attr("specialization") = "pain_detection"
        self.get_attr("category") = "agents_copywriters"
        self.get_attr("agent_name") = "pain_detector"
...
def create_agent(**kwargs) -> PainDetectorAgent:
    """Factory function para criar instância do agente."""
    return PainDetectorAgent(**kwargs)
